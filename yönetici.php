...
<div class=" yesil" align="center" >	
	...
	<form action ="" method="post">
		<table cellpadding="5" cellspacing="5">
			<tr>			
				<td><input type="text"placeholder="Yönetici Adı" class="form-control"name="adsoyad" /></td>
			</tr>
			<tr>			
				<td><input type="password"class="form-control" placeholder="Parola" name="eposta" /></td>
			</tr>
			<tr>				
				<td><input type="submit" class="btn btn-primary" name ="Gönder"value="Giriş" />	</td>			
			</tr>			
		</table>
	</form>
...
{
	$eposta=$_POST["adsoyad"];
	$parola=$_POST["eposta"];
			
	if ($eposta=="admin" && $parola=="123" )
	{					
	header('Location:yöneticiekrani.php');
	exit();				
	}	
}
?>
