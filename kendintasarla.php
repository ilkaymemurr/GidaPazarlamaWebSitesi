      ...
      <header class="masthead">
		<div class="nav-scroller py-1 mb-2">
			<nav class="nav d-flex justify-content-between">
				...
				<a class="p-2 text-muted" href="">İletişim</a>
	  ...
	  <div class="row">
        <nav class="col-sm-3 d-none d-sm-block bg-light sidebar">
          <ul class="nav nav-pills flex-column">
            <li class="nav-item">
              <a class="nav-link navlink3" href="kendintasarla/cikolata.php">Çikolata</a>
            </li>
            <li class="nav-item">
              <a class="nav-link navlink3" href="kendintasarla/kutusepet.php">Kutu - Sepet</a>
            </li>
            <li class="nav-item">
              <a class="nav-link navlink3" href="kendintasarla/tabak.php">Tabak</a>
            </li>
            
            <li class="nav-item">
              <a class="nav-link navlink3" href="kendintasarla/bebekkapisusu.php">Bebek Kapı Süsü</a>
				   <nav class="nav nav-pills flex-column">
						<a style="color:blue;"class="nav-link ml-3 my-1 navlink3" href="kendintasarla/urungovdesi.php">Ürün Gövdesi</a>
						<a style="color:blue;"class="nav-link ml-3 my-1 navlink3" href="kendintasarla/harflersayilar.php">Harfler Sayılar</a>
						<a style="color:blue;"class="nav-link ml-3 my-1 navlink3" href="kendintasarla/aksesuar.php">Aksesuar</a>
						
					</nav>
            </li>
            <li class="nav-item">
              <a class="nav-link navlink3" href="kendintasarla/önerilenler.php">Önerilenler</a>
            </li>
...
<form action="" method="GET">
          <section class="row text-center placeholders">
            <div class="col-6 col-sm-3 placeholder">
				<img src="../veri/draje/1.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
				<h4>1</h4>        
				
				<span class="badge badge-success">19.90₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet1" value="Sepete Ekle"></h5>
            </div>	
            <div class="col-6 col-sm-3 placeholder">
              <img src="../veri/draje/2.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>2</h4>
              
				<span class="badge badge-success">52.99₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet2" value="Sepete Ekle"></h5>
            </div>
			<div class="col-6 col-sm-3 placeholder">
              <img src="../veri/draje/3.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>3</h4>
            
				<span class="badge badge-success">72.99₺</span></p>
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="Badem Sekeri Mavi 250g")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="Gourmet Collection Draje 1924 Altin Kutu 400g")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="Gourmet Collection Draje Prestij 700g")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
