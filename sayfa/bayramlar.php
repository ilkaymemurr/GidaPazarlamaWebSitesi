...
<form action="" method="get">
          <section class="row text-center placeholders">
            <div class="col-6 col-sm-3 placeholder">
				<img src="../veri/ozelgunler/bayramlar/1.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
				<h4>Karışık Meyve Dolgulu Şeker 400g</h4>             
				
				<span class="badge badge-success">8.95₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet1" value="Sepete Ekle"></h5>
            </div>	
            <div class="col-6 col-sm-3 placeholder">
              <img src="../veri/ozelgunler/bayramlar/2.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Luxury Praline Spesiyal Çikolata Mor Kutu 228g</h4>
             
				<span class="badge badge-success">28.95₺</span></p>
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="Karisik Meyve Dolgulu Seker 400g")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="Luxury Praline Spesiyal Cikolata Mor Kutu 228g")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
