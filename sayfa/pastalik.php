...
<form action="" method="GET">
          <section class="row text-center placeholders">
            <div class="col-6 col-sm-3 placeholder">
				<img src="../veri/pastacılık/1.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
				<h4>Kuvertür Sütlü Çikolata 250g</h4>             
				
				<span class="badge badge-success">11₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet1" value="Sepete Ekle"></h5>
            </div>	
            <div class="col-6 col-sm-3 placeholder">
              <img src="../veri/pastacılık/2.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Sütlü Damla Çikolata 250g</h4>
              
				<span class="badge badge-success">10₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet2" value="Sepete Ekle"></h5>
            </div>    
			<div class="col-6 col-sm-3 placeholder">
              <img src="../veri/pastacılık/3.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Toz Kakao 200g</h4>
              
				<span class="badge badge-success">12.50₺</span></p>
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="Kuvertur Sutlu Cikolata 250g")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="Sutlu Damla Cikolata 250g")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
