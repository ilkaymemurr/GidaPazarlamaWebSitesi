...
<form action="" method="get"
          <section class="row text-center placeholders">
            <div class="col-6 col-sm-3 placeholder">
				<img src="../veri/kolonya/1.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
				<h4>Hazan Kolonyası</h4>             
				
				<span class="badge badge-success">49.90₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet1" value="Sepete Ekle"></h5>
            </div>	
            <div class="col-6 col-sm-3 placeholder">
              <img src="../veri/kolonya/2.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Hediyelik Set</h4>
              
				<span class="badge badge-success">179.90₺</span></p>
