...
<form action="" method="GET">
          <section class="row text-center placeholders">
            <div class="col-6 col-sm-3 placeholder">
				<img src="KendinYap/kutu-sepet/1.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
				<h4>Karton Çikolata Kutu 5 adet</h4>        
				
				<span class="badge badge-success">13₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet1" value="Sepete Ekle"></h5>
            </div>	
            <div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/kutu-sepet/2.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Ahşap Kutu</h4>
              
				<span class="badge badge-success">32₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet2" value="Sepete Ekle"></h5>
            </div>
			<div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/kutu-sepet/3.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Ahşap Kutu Kare</h4>
            
				<span class="badge badge-success">44₺</span></p>
				<h5><input  class="btn btn-primary"  type="submit" name="kaydet3" value="Sepete Ekle"></h5>
            </div> 
			<div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/kutu-sepet/4.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Büyük Boy Hediye Çikolata Kutusu</h4>
            
				<span class="badge badge-success">105₺</span></p>
				<h5><input  class="btn btn-primary"  type="submit" name="kaydet4" value="Sepete Ekle"></h5>
            </div> <div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/kutu-sepet/5.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Küçük Boy Hediye Çikolata Kutusu</h4>
            
				<span class="badge badge-success">85₺</span></p>
				<h5><input  class="btn btn-primary"  type="submit" name="kaydet5" value="Sepete Ekle"></h5>
            </div> <div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/kutu-sepet/6.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Hoşgeldin Mavi Bebek</h4>
            
				<span class="badge badge-success">60₺</span></p>
				<h5><input  class="btn btn-primary"  type="submit" name="kaydet6" value="Sepete Ekle"></h5>
            </div> 
			<div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/kutu-sepet/7.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Hoşgeldin Pembe Bebek</h4>
            
				<span class="badge badge-success">55₺</span></p>
				<h5><input  class="btn btn-primary"  type="submit" name="kaydet7" value="Sepete Ekle"></h5>
            </div> <div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/kutu-sepet/8.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Hoşgeldin Pembe Tüylü Bebek</h4>
            
				<span class="badge badge-success">60₺</span></p>
				<h5><input  class="btn btn-primary"  type="submit" name="kaydet8" value="Sepete Ekle"></h5>
            </div> <div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/kutu-sepet/9.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Kalpli Kutu</h4>
            
				<span class="badge badge-success">70₺</span></p>
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="KT karton cikolata kutu 5adet")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="KT seniseviyorum ahsap kutu")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="KT kalpli ahsap kutu")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="KT buyuk boy hediye kutu")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="KT kucuk boy hediye kutu")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="KT hosgeldin mavi bebek")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="KT hosgeldin pembe bebek")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
...
$sonuc = $baglanti->query($sorgu);
			...
			if($sonuc->num_rows>0)
			{
				while($kayit = $sonuc ->fetch_assoc()) // fetch bir kayit geliyor sırayla diğerleride
				{
					...
					if($kayit["adi"]=="KT hosgeldin tuylu pempe bebek")
					{
					$id=$kayit["id"];
					$adi=$kayit["adi"];
					$fiyat= $kayit["fiyat"];
