...
<form action="" method="GET">
          <section class="row text-center placeholders">
            <div class="col-6 col-sm-3 placeholder">
				<img src="KendinYap/oneri/1.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
				<h4>Öneri 1</h4>        
            ...
            <div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/oneri/2.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Öneri 2</h4>
              
				<span class="badge badge-success">100₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet2" value="Sepete Ekle"></h5>
            </div>
			<div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/oneri/3.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Öneri 3</h4>
            
				<span class="badge badge-success">140₺</span></p>
