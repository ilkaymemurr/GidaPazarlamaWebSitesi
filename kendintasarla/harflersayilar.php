...
<form action="" method="GET">
          <section class="row text-center placeholders">
            <div class="col-6 col-sm-3 placeholder">
				<img src="KendinYap/bebekkapisusu/harfler-sayilar/1.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
				<h4>Çilek Harfler Stil 1 adet</h4>        
				
				<span class="badge badge-success">2₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet1" value="Sepete Ekle"></h5>
            </div>	
            <div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/bebekkapisusu/harfler-sayilar/2.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Keçe Harfler Stil 2 adet</h4>
              
				<span class="badge badge-success">2₺</span></p>
				<h5><input  class="btn btn-primary"type="submit" name="kaydet2" value="Sepete Ekle"></h5>
            </div>
			<div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/bebekkapisusu/harfler-sayilar/3.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Sayılar Stil 1 adet</h4>
            
				<span class="badge badge-success">1₺</span></p>
				<h5><input  class="btn btn-primary"  type="submit" name="kaydet3" value="Sepete Ekle"></h5>
            </div> <div class="col-6 col-sm-3 placeholder">
              <img src="KendinYap/bebekkapisusu/harfler-sayilar/4.jpg" width="200" height="200" class="img-fluid rounded-circle" alt="Generic placeholder thumbnail">
              <h4>Sayılar Stil 2 adet</h4>
